...
const HomePage = () => {
  ...
  return (
    <div className="home-wrapper">
      ...
      <a href="https://github.com/rocket-developer-sketch/new-version-enjoyGames-frontend" target="_blank" rel="noopener noreferrer">
        <button className="repo-button">
          Frontend Repo
        </button>
      </a>   
      <a href="https://github.com/rocket-developer-sketch/new-version-enjoyGames-backend" target="_blank" rel="noopener noreferrer">
        <button className="repo-button">
          Backend Repo
        </button>
      </a>
